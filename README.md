...
3. [Types](#types)
..3.1 [Types Parameters](#types-parameters)
..3.2 [Types Methods](#types-methods)
..3.3 [How to check data value?](#how-to-check-data-value)
..3.4 [How to use interface?](#how-to-use-interface)
4. [Validations](#types)
..4.1 [Validations Parameters](#validations-parameters)
..4.2 [Validations Methods](#validations-methods)
..4.3 [Validations Phone Format](#validations-phone-format)
..4.4 [Use data validations](#use-data-validations)
